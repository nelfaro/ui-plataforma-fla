...
export const CHATWOOT_URL = import.meta.env.VITE_CHATWOOT_URL || 'https://agente-fla-chatwoot.x5miqk.easypanel.host';
export const WHATSAPP_URL = import.meta.env.VITE_WHATSAPP_URL || 'https://agente-fla-puentewhatsapp.x5miqk.easypanel.host/';
